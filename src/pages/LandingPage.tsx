...
function LandingPage() {
  ...
  return (
    <main>
      ...
      <section className="px-40 py-32 space-y-16 bg-neutral text-white">
        <div className="space-y-6">
          <h1 className="px-4 border-r-4 border-secondary text-4xl font-bold">
        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-2">
          ...
          />
          <ProductCard
            headline={t("landingPage.products.categories.aggregates.headline")}
            description={t(
          ...
          <ProductCard
            ...
            description={t("landingPage.products.categories.steel.description")}
            imgPath={"src/assets/steel.jpg"}
            icon={<SteelIcon width={100} height={100} />}
          />
          <ProductCard
            headline={t("landingPage.products.categories.wood.headline")}
            description={t("landingPage.products.categories.wood.description")}
            imgPath={"src/assets/wood.jpg"}
            icon={<WoodIcon width={100} height={100} />}
          />
        </div>
        <button
          className="flex items-center gap-x-4 mx-auto px-6 py-4 text-lg font-medium
                    transition-colors border border-white rounded-lg hover:border-secondary
                    hover:bg-secondary"
        >
